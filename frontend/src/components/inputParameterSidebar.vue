<template>
  <li>
        ...
        <a href="#" v-on:click="input_parameter_flag = !input_parameter_flag">
          <i class="fas fa-keyboard sidebar_icons"></i><strong>Input Parameter</strong>
          <i class="fas downmenu_icon" 
          v-bind:class="{toggle_dropdown_menu : !input_parameter_flag, 'fa-caret-down': !sidebar_toggle}"></i>
        </a>
